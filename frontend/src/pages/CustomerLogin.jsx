        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 border-t border-slate-200/50 pt-6 z-10 w-full max-w-lg mx-auto">
          ...
          <div className="light-glass-card p-3 rounded-2xl flex items-center space-x-3 text-left transition-all duration-300 hover:scale-[1.03] hover:-translate-y-0.5 hover:shadow-lg group cursor-pointer border border-white/60">
            ...
            <div className="text-left leading-tight">
              <h5 className="text-slate-900 font-extrabold text-xs transition-colors duration-200 group-hover:text-purple-700">{t('smartMeasurements')}</h5>
          ...
          <div className="light-glass-card p-3 rounded-2xl flex items-center space-x-3 text-left transition-all duration-300 hover:scale-[1.03] hover:-translate-y-0.5 hover:shadow-lg group cursor-pointer border border-white/60">
            ...
            <div className="text-left leading-tight">
              <h5 className="text-slate-900 font-extrabold text-xs transition-colors duration-200 group-hover:text-indigo-700">{t('orderManagement')}</h5>
          ...
          <div className="light-glass-card p-3 rounded-2xl flex items-center space-x-3 text-left transition-all duration-300 hover:scale-[1.03] hover:-translate-y-0.5 hover:shadow-lg group cursor-pointer border border-white/60">
            ...
            <div className="text-left leading-tight">
              <h5 className="text-slate-900 font-extrabold text-xs transition-colors duration-200 group-hover:text-pink-700">{t('smartNotifications')}</h5>
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-4 sm:p-6 md:p-8 relative min-h-screen z-10">
        ...
        <div className="auth-card">
          ...
          <div className="mb-5 text-center sm:text-left">
            <h3 className="text-slate-955 text-2xl font-black tracking-tight leading-tight">
