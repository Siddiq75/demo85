        ...
        <div className="p-4 border-b border-slate-200/80 dark:border-white/5 space-y-3 bg-slate-100/30 dark:bg-transparent">
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="w-full bg-slate-100/80 dark:bg-white/5 border border-slate-200/50 dark:border-white/5 rounded-xl pl-10 pr-4 py-2 text-xs text-slate-800 dark:text-white placeholder-slate-450 dark:placeholder-slate-550 focus:outline-none focus:border-purple-500/50 focus:bg-white dark:focus:bg-slate-950/40 transition-all duration-300 shadow-sm"
            />
          </div>
        </div>

        {/* List */}
        <div className="flex-grow overflow-y-auto p-2 space-y-1.5 animate-fade-in">
            ...
            filteredConversations.map(chat => {
              ...
              return (
                <div
                  ...
                  className={`p-3 flex items-center space-x-3 cursor-pointer rounded-2xl border transition-all duration-300 ${
                    isSelected 
                      ? 'bg-gradient-to-r from-purple-500/10 to-indigo-500/10 dark:from-purple-500/10 dark:to-indigo-500/10 border-purple-500/35 shadow-sm shadow-purple-500/5' 
                      : 'hover:bg-slate-100/50 dark:hover:bg-white/5 border-transparent hover:border-slate-200/40 dark:hover:border-white/5'
                  }`}
                >
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500/20 to-indigo-500/20 text-purple-650 dark:text-purple-400 flex items-center justify-center font-bold text-xs flex-shrink-0 shadow-inner border border-purple-500/10">
            ...
            <div className="flex-grow flex flex-col h-full min-w-0 relative z-10">
              ...
              <div className="p-4 border-b border-slate-200/80 dark:border-white/5 flex items-center justify-between bg-slate-100/90 dark:bg-slate-900/40 backdrop-blur-md shadow-sm">
                <div className="flex items-center space-x-3 text-left">
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-indigo-650 text-white flex items-center justify-center font-bold text-xs shadow-md border border-purple-400/20">
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          <div className={`absolute right-2.5 bottom-1.5 flex items-center space-x-1 text-[9px] select-none ${
                            isTailor ? 'text-white/60 group-hover:text-white/90' : 'text-slate-500 dark:text-white/40'
                          } transition-colors`}>
                      ...
                      <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-2 text-xs">
                          {[
                            ...
                            <div key={field.key} className="bg-white/50 dark:bg-white/5 border border-slate-200/50 dark:border-white/5 p-2 rounded-xl text-center shadow-sm">
                              <span className="block text-[9px] uppercase font-extrabold text-slate-450 dark:text-slate-500">{field.label}</span>
                              <strong className="text-xs font-black text-slate-850 dark:text-white block mt-0.5">
                        ...
                        {customerMeasurements.notes && (
                          <div className="bg-white/50 dark:bg-white/5 border border-slate-200/50 dark:border-white/5 p-3 rounded-xl text-left text-[11px] text-slate-700 dark:text-gray-300">
                            <span className="text-[9px] font-black uppercase text-slate-450 dark:text-slate-500 block mb-1">Tailor Notes</span>
                            <p className="leading-relaxed font-medium italic">{customerMeasurements.notes}</p>
                          </div>
                        )}
                        ...
                        {customerMeasurements.reference_image_url && (
                          <div className="space-y-1.5 text-left">
                            ...
                            <div className="bg-white/50 dark:bg-white/5 border border-slate-200/50 dark:border-white/5 rounded-xl p-2 h-28 flex items-center justify-center overflow-hidden shadow-sm">
                              <img
                    ...
                    {loadingCustomerInfo ? (
                      ...
                      <div className="space-y-2 max-h-64 overflow-y-auto pr-1">
                        {customerOrders.map(order => (
                          <div key={order.id} className="bg-white/50 dark:bg-white/5 border border-slate-200/50 dark:border-white/5 p-2.5 rounded-xl text-left relative overflow-hidden shadow-sm">
